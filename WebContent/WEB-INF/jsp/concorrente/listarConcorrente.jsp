	...
	<table border="1">
		...
		<c:forEach var="concorrente" items="${concorrentes}">
			<tr>
				...
				<td><a
					href="mvc?logica=concorrente.FormularioAtualizarConcorrenteLogica&id=${concorrente.id}">Atualizar</a>
					<a href="mvc?logica=concorrente.RemoverConcorrenteLogica&id=${concorrente.id}">Remover</a>
					<a
					href="mvc?logica=concorrente.ListarClientePorConcorrenteLogica&id=${concorrente.id}">Listar
						Clientes</a></td>
			</tr>
		</c:forEach>
	</table>
