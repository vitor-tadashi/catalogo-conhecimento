...
public class EquipeDAO extends GenericDAOImpl<EquipeBean, Integer> {
	...
	public List<EquipeBean> obterPorProjeto(ProjetoBean projeto) throws ClassNotFoundException, SQLException {
		...
		String sql = "  select" + "	e.idEquipe, e.nome, e.observacao" + "  from"
				+ "	Projeto as p inner join ProjetoEquipe as pe" + "	on p.idProjeto = pe.idProjeto"
				+ "	inner join Equipe as e" + "	on e.idEquipe = pe.idEquipe" + "  where p.idProjeto = ?";
